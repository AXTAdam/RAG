...
- Trained and tested 2 out of 8 LLMs.
- Designed multiple evaluation experiments and completed four types of evaluations for all 8 LLMs.
- Annotated experimental datasets for training and evaluation.
